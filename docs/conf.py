...
sys.path.insert(0, os.path.abspath("../digitalearth"))
...
# of the sidebar.
"""
html_logo = "images/digitalearth.png"
"""
...
man_pages = [("index", "digitalearth", "digitalearth Documentation", [author], 1)]
